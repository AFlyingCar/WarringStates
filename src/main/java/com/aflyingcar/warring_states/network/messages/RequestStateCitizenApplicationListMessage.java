...
public class RequestStateCitizenApplicationListMessage extends TrackedMessage {
    private UUID stateID;

    public RequestStateCitizenApplicationListMessage() {
    }

    public RequestStateCitizenApplicationListMessage(UUID stateID) {
