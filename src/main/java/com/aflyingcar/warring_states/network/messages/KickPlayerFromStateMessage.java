...
public class KickPlayerFromStateMessage implements IMessage {
    private UUID stateID;
    private UUID playerID;
    private DummyCitizen citizen;

    public KickPlayerFromStateMessage() {
    }

    public KickPlayerFromStateMessage(@Nonnull UUID stateID, @Nonnull EntityPlayer player, @Nonnull DummyCitizen citizen) {
